...
def main():
    ...
    path_cran = os.getcwd() + '/static/collections/Cranfield'
    path_med = os.getcwd() + '/static/collections/Medline'

    queries_cran = open(os.getcwd() + '/static/evaluation/prueba_cran/cranquery.txt','r')
    queries_med = open(os.getcwd() + '/static/evaluation/prueba_med/medquery.txt','r')

    resultFile_cran = open(os.getcwd() + '/static/evaluation/prueba_cran/cranqrel.txt','r')
    resultFile_med = open(os.getcwd() + '/static/evaluation/prueba_med/medqrel.txt','r')
